...
import { Compass, LayoutGrid, UserCircle, Users } from 'lucide-react';
                ...
                {NAV_ITEMS.map((item) => {
                    ...
                    return (
                        <Link
                            ...
                            className={`flex flex-col items-center justify-center gap-1 rounded-2xl px-2 py-2 text-[11px] font-semibold transition-colors ${active
